...
const displaySearchResult = books => {
  if (books.docs.length === 0) {
                displayMessageDiv.innerHTML = <h1><span class="text-danger">Sorry!</span> Search is not found ❌</h1>;


            searchResult.textContent = '';
  } else {
                displayMessageDiv.innerHTML = <h1><span class="text-warning"> About </span>  ${books.numFound}<span class="text-warning"> Search Results found </span></h1>;
                    ...
                    <hr>
                        <div class="card-body">
                            ...
                            <p class="card-text">Author Name: ${
                                authorName ? authorName : ' No Author Name Found '
                            } </p>
